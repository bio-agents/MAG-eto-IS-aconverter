package org.isaagents.magetoisatab.io.fileprocessing;
...
public enum InferredProtocolTypes {
   ...
   //ASSAY_A("Labeled Extract Name", "Assay Name", "library sequencing"),
   ASSAY_B("Extract Name", "Assay Name", "library preparation"),
   // ASSAY_C("Comment [Platform_title]", "Parameter Value[sequencing instrument]", "nucleic acid sequencing"),
